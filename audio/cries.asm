...
; Johto
	dw $001E, $00EE, $017F  ; CHIKORITA (TODO)
	dw $001E, $00EE, $017F  ; BAYLEEF (TODO)
	dw $001E, $00EE, $017F  ; MEGANIUM (TODO)
	dw $002B, 839,  128     ; CYNDAQUIL
	dw $002B, 801,  288     ; QUILAVA
	dw $001E, $00EE, $017F  ; TYPHLOSION (TODO)
	...
	dw $002B, 720,  272     ; LANTURN
	dw $001E, $00EE, $017F  ; PICHU (TODO)
	dw $0033, 97,  145      ; CLEFFA
	dw $001E, $00EE, $017F  ; IGGLYBUFF (TODO)
	dw $002C, 16,  256      ; TOGEPI
	dw $002D, 59,   56      ; TOGETIC
	dw $0032, -103,  256    ; NATU
	dw $0032, -167,  360    ; XATU
	dw $0027, $022,  $0d8   ; MAREEP
	dw $0027, -$007,  $180  ; FLAAFFY
	dw $001E, $00EE, $017F  ; AMPHAROS (TODO)
	dw $0033, 132,  336     ; BELLOSSOM
	dw $0026, 283,  288     ; MARILL
	dw $0026, 182,  384     ; AZUMARILL
	dw $0033, 3904,  384    ; SUDOWOODO
	dw $0033, -675,  456    ; POLITOED
	dw $0033, 59,  200      ; HOPPIP
	dw $0033, 39,  312      ; SKIPLOOM
	dw $0033, 0,  384       ; JUMPLUFF
	dw $001E, $00EE, $017F  ; AIPOM (TODO)
	dw $0026, $12b,  $0b8   ; SUNKERN
	dw $001E, $00EE, $017F  ; SUNFLORA (TODO)
	dw $001E, $00EE, $017F  ; YANMA (TODO)
	dw $001E, $00EE, $017F  ; WOOPER (TODO)
	dw $001E, $00EE, $017F  ; QUAGSIRE (TODO)
	dw $001E, $00EE, $017F  ; ESPEON (TODO)
	dw $001A, -$0e9,  $0f0  ; UMBREON
	dw $0026, -$01f,  $180  ; MURKROW
	dw $0031, 260,  512     ; SLOWKING
	dw $0028, $130,  $0e8   ; MISDREAVUS 
	dw $0028, $162,  $100   ; UNOWN
	dw $001E, $00EE, $017F  ; WOBBUFFET (TODO)
	dw $002E, 65,  512      ; GIRAFARIG
	dw $0031, 128,  256     ; PINECO
	dw $0031, 0,  384       ; FORRETRESS
	dw $001E, $00EE, $017F  ; DUNSPARCE (TODO)
	dw $001E, $00EE, $017F  ; GLIGAR (TODO)
	dw $001E, $00EE, $017F  ; STEELIX (TODO)
	dw $001E, $00EE, $017F  ; SNUBBULL (TODO)
	dw $001E, $00EE, $017F  ; GRANBULL (TODO)
	dw $0031, 352,  224     ; QWILFISH 
	dw $001E, $00EE, $017F  ; SCIZOR (TODO)
	dw $001E, $00EE, $017F  ; SHUCKLE (TODO)
	dw $001E, $00EE, $017F  ; HERACROSS (TODO)
	dw $001E, $00EE, $017F  ; SNEASEL (TODO)
	dw $0030, 1954,  110    ; TEDDIURSA
	dw $0030, 1600,  216    ; URSARING
	dw $001E, $00EE, $017F  ; SLUGMA (TODO)
	dw $001E, $00EE, $017F  ; MAGCARGO (TODO)
	dw $002B, 510,  320     ; SWINUB
	dw $001E, $00EE, $017F  ; PILOSWINE (TODO)
	dw $001E, $00EE, $017F  ; CORSOLA (TODO)
	dw $001E, $00EE, $017F  ; REMORAID (TODO)
	dw $001E, $00EE, $017F  ; OCTILLERY (TODO)
	dw $0030, 2,  106       ; DELIBIRD
	dw $001E, $00EE, $017F  ; MANTINE (TODO)
	dw $001E, $00EE, $017F  ; SKARMORY (TODO)
	dw $002B, 57,  320      ; HOUNDOUR
	dw $001E, $00EE, $017F  ; HOUNDOOM (TODO)
	...
	dw $001E, $00EE, $017F  ; HITMONTOP (TODO)
	dw $0026, $068,  $100   ; SMOOCHUM 
	dw $001E, $00EE, $017F  ; ELEKID (TODO)
	dw $0030, 374,   58     ; MAGBY
	dw $001E, $00EE, $017F  ; MILTANK (TODO)
	dw $0031, 659,  320     ; BLISSEY
...
; Hoenn - All TODO past this point
