...
;dw Cry_28_BankF ; SLOWKING BASE
;dw Cry_29_BankF ; CHIKORITA BASE
;dw Cry_2A_BankF ; TOTODILE BASE
;dw Cry_2B_BankF ; GLIGAR BASE
;dw Cry_2C_BankF ; CLEFFA BASE
...
;dw Cry_2B_BankF ; NATU BASE
;dw Cry_2C_BankF ; TEDDIURSA BASE
