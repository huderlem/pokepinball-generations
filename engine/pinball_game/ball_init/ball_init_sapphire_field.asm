InitBallSapphireField:
	ld a, [wReturningFromBonusStage]
	and a
	jp nz, StartBallAfterBonusStageSapphireField
	ld a, $0
	ld [wBallXPos], a
	ld a, $a7
	ld [wBallXPos + 1], a
	...
	ld [wd580], a
	callba InitSapphireFieldCollisionAttributes
	ld a, [wLostBall]
	and a
	ret z
	xor a
...
StartBallAfterBonusStageSapphireField: ; 0x1c129
	ld a, $0
	ld [wBallXPos], a
	ld a, $50
	ld [wBallXPos + 1], a
