ResolveSilverFieldTopGameObjectCollisions: ; 0x1c715
	call ResolveShellderCollision_SilverField
	call ResolveSilverStageSpinnerCollision
	call ResolveBallUpgradeTriggersCollision_SilverField
	call UpdateBallTypeUpgradeCounter_SilverField
	call UpdateCAVELightsBlinking_SilverField
	call ResolveSilverStageBoardTriggerCollision
	call ResolveSilverStagePikachuCollision
	call ResolveSlowpokeCollision_SilverField
	call ResolveCloysterCollision_SilverField
	call ApplySlotForceField_SilverFieldTop
	call ResolvePsyduckPoliwagCollision_SilverField
	call ResolveForceFieldCollision_SilverField
	call OpenSlotCave_SilverField
	call UpdateForceFieldDirection_SilverField
	call UpdateForceFieldGraphics_SilverField
	callba UpdateBallSaverState
	call UpdateBlinkingPokeballs_SilverField
	call UpdateMapMoveCounters_SilverFieldTop
	callba ShowExtraBallMessage
	ld a, $0
	callba CheckSpecialModeColision
	ret

ResolveSilverFieldBottomGameObjectCollisions: ; 0x1c769
	call ResolveWildMonCollision_SilverField
	call ResolveBumpersCollision_SilverField
	call ResolvePsyduckPoliwagCollision_SilverField
	call UpdateSilverStageSpinner
	call UpdatePinballUpgradeBlinkingAnimation_SilverField
	call UpdateBallTypeUpgradeCounter_SilverField
	call ResolveCAVELightCollision_SilverField
	call ResolveSilverStagePinballLaunchCollision
	call ResolveSilverStagePikachuCollision
	call UpdateArrowIndicators_SilverField
	call ResolveBonusMultiplierCollision_SilverField
	call ResolveSlotCollision_SilverField
	call OpenSlotCave_SilverField
	call ApplySlotForceField_SilverFieldBottom
	call UpdateForceFieldDirection_SilverField
	callba UpdateAgainText
	callba UpdateBallSaver
	call UpdatePokeballs_SilverField
	call UpdateMapMoveCounters_SilverFieldBottom
	callba ShowExtraBallMessage
	ld a, $0
	callba CheckSpecialModeColision
	ret

InitSilverFieldCollisionAttributes: ; 0x1c7c7
	ld a, $0
	ld [wStageCollisionState], a
	callba LoadStageCollisionAttributes
	ret

ResolveSilverStagePinballLaunchCollision: ; 0x1c7d7
...
.dontLaunch
	...
	call ChooseInitialMap_SilverField
	ld a, $1
...
ResolveShellderCollision_SilverField: ; 0x1c9c1
	ld a, [wWhichShellder]
	and a
	jr z, .noCollision
	xor a
	ld [wWhichShellder], a
	call ApplyShellderCollision_SilverField
	ld a, [wBlueStageForceFieldFlippedDown]
	and a
...
ApplyShellderCollision_SilverField: ; 0x1ca29
	ld a, $ff
	ld [wRumblePattern], a
	ld a, $3
...
ResolveWildMonCollision_SilverField: ; 0x1ca4a
...
ResolveSilverStageSpinnerCollision: ; 0x1ca5f
	ld a, [wSpinnerCollision]
	and a
	jr z, UpdateSilverStageSpinner
	xor a
...
.asm_1cadb
	...
	jr nz, .asm_1caff
	call PlaySpinnerChargingSoundEffect_SilverField
	ret
...
PlaySpinnerChargingSoundEffect_SilverField: ; 0x1cb1c
	ld a, [wd51e]
	and a
	ret nz
	ld a, [wPikachuSaverCharge]
	ld c, a
	ld b, $0
	ld hl, SpinnerChargingSoundEffectIds_SilverField
	add hl, bc
	ld a, [hl]
	ld e, a
	ld d, $0
...
SpinnerChargingSoundEffectIds_SilverField:
	db $12, $13, $14, $15, $16, $17, $18, $19, $1A, $1B, $1C, $1D, $1E, $1F, $20, $11

UpdateSpinnerChargeGraphics_SilverField: ; 0x1cb43
; Loads the correct graphics that show the lightning bolt icon for the spinner's current charge.
	ld a, [wPikachuSaverCharge]
	ld c, a
	sla c
	ld b, $0
	ld hl, TileDataPointers_1cb60_SilverField
	ld a, [hGameBoyColorFlag]
	and a
	jr z, .asm_1cb56
	ld hl, TileDataPointers_1cd10_SilverField
.asm_1cb56
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	ld l, a
	ld a, Bank(TileDataPointers_1cb60_SilverField)
	call QueueGraphicsToLoad
	ret

INCLUDE "data/queued_tiledata/silver_field/spinner.asm"

ResolveBumpersCollision_SilverField: ; 1ce40
	ld a, [wWhichBumper]
	and a
	jr z, .noNewCollision
	call LoadBumpersGraphics_SilverField
	call LightUpBumper_SilverField
	xor a
	ld [wWhichBumper], a
	call ApplyBumperCollision_SilverField
.noNewCollision
	...
	call z, LoadBumpersGraphics_SilverField
	ret

LightUpBumper_SilverField: ; 0x1ce60
...
LoadBumperGraphics_SilverField: ; 0x1ce7a
	sla a
	ld c, a
	ld b, $0
	ld hl, TileDataPointers_1ceca_SilverField
	ld a, [hGameBoyColorFlag]
	and a
	jr z, .asm_1ce8a
	ld hl, TileDataPointers_1cf3a_SilverField
.asm_1ce8a
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	ld l, a
	ld a, Bank(TileDataPointers_1ceca_SilverField)
	call QueueGraphicsToLoad
	ret

ApplyBumperCollision_SilverField: ; 0x1ce94
	ld a, $ff
	ld [wRumblePattern], a
	ld a, $3
	ld [wRumbleDuration], a
	...
	ld c, a
	ld b, $0
	ld hl, BumperCollisionAngleDeltas_SilverField
	add hl, bc
...
BumperCollisionAngleDeltas_SilverField:
	db -8, 8

INCLUDE "data/queued_tiledata/silver_field/bumpers.asm"

ResolveSilverStageBoardTriggerCollision: ; 0x1cfaa
...
.asm_1cfe5
	...
	and a
	call nz, HandleSecondaryLeftAlleyTrigger_SilverField
	ld a, [wCollidedAlleyTriggers + 1]
	and a
	call nz, HandleSecondaryRightAlleyTrigger_SilverField
	ld a, [wCollidedAlleyTriggers + 2]
	and a
	call nz, HandleLeftAlleyTrigger_SilverField
	ld a, [wCollidedAlleyTriggers + 3]
	and a
	call nz, HandleRightAlleyTrigger_SilverField
	ret

HandleSecondaryLeftAlleyTrigger_SilverField: ; 0x1d010
; Ball passed over the secondary left alley trigger point in the Silver Field.
	xor a
...
HandleSecondaryRightAlleyTrigger_SilverField: ; 0x1d047
; Ball passed over the secondary right alley trigger point in the Silver Field.
	xor a
...
HandleLeftAlleyTrigger_SilverField: ; 0x1d080
; Ball passed over the left alley trigger point in the Silver Field.
	xor a
...
HandleRightAlleyTrigger_SilverField: ; 0x1d091
; Ball passed over the right alley trigger point in the Silver Field.
	xor a
...
ResolveSilverStagePikachuCollision: ; 0x1d0a1
	ld a, [wWhichPikachu]
	and a
	jr z, .asm_1d110
	xor a
	...
	jr nz, .asm_1d0fc
.asm_1d0c9
	ld hl, PikachuSaverAnimationData_SilverField
...
.asm_1d0fc
	ld hl, PikachuSaverAnimation2Data_SilverField
	ld de, wPikachuSaverAnimation
	call InitAnimation
	ld a, $2
	ld [wd51c], a
...
.asm_1d110
	ld a, [wd51c]
	and a
	call z, SetPikachuSaverSide_SilverField
	call UpdatePikachuSaverAnimation_SilverField
	ld a, [wPikachuSaverCharge]
	cp MAX_PIKACHU_SAVER_CHARGE
	ret nz
	ld a, [wd51e]
...
UpdatePikachuSaverAnimation_SilverField: ; 0x1d133
	ld a, [wd51c]
	cp $1
	jr nz, .asm_1d1ae
	ld hl, PikachuSaverAnimationData_SilverField
...
PikachuSaverAnimationData_SilverField: ; 0x1d1d1
...
PikachuSaverAnimation2Data_SilverField: ; 0x1d1f6
; Each entry is [duration][OAM id]
	db $0C, $02
	db $01, $00
	db $00

SetPikachuSaverSide_SilverField: ; 0x1d1fb
...
ResolveSlowpokeCollision_SilverField: ; 0x1d216
	...
	lb de, $00, $05
	call PlaySoundEffect
	ld hl, SlowpokeCollisionAnimationData_SilverField ; 0x1d312
...
SlowpokeCollisionAnimationData_SilverField: ; 0x1d312
...
ResolveCloysterCollision_SilverField: ; 0x1d32d
	...
	lb de, $00, $05
	call PlaySoundEffect
	ld hl, CloysterCollisionAnimationData_SilverField
...
CloysterCollisionAnimationData_SilverField: ; 0x1d41d
; Each entry is [OAM id][duration]
	db $08, $01
	db $06, $02
	db $06, $02
...
ResolveBonusMultiplierCollision_SilverField: ; 0x1d438
	call UpdateBonusMultiplierRailingLight_SilverField
	ld a, [wWhichBonusMultiplierRailing]
	and a
	jp z, UpdateBonusMultiplierRailing_SilverField
	xor a
...
UpdateBonusMultiplierRailing_SilverField: ; 0x1d51b
	call ShowBonusMultiplierMessage_SilverField ; only shows the scrolling message when appropriate
	ld a, [wd612]
	and a
	jr z, .asm_1d559
	dec a
...
.asm_1d64d
	...
	ld b, $0
	sla c
	ld hl, BonusMultiplierRailingTileDataPointers_1d97a_SilverField
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	ld l, a
	ld a, Bank(BonusMultiplierRailingTileDataPointers_1d97a_SilverField)
	call QueueGraphicsToLoad
	ret

UpdateBonusMultiplierRailingLight_SilverField: ; 0x1d692
...
ResolvePsyduckPoliwagCollision_SilverField: ; 0x1dbd2
	ld a, [wWhichPsyduckPoliwag]
	and a
	jp z, UpdatePsyduckAndPoliwag_SilverField
	cp $2
	jr z, .hitPsyduck
	; hit poliwag
	xor a
...
.asm_1dc5c
	...
	cp $3
	ccf
	call z, HitPsyduck3Times_SilverField
	ld a, $2
	ld [wPsyduckState], a
	ld a, $28
...
.asm_1dc8a
	call AddScorePsyduckOrPoliwag_SilverField
	ret

UpdatePsyduckAndPoliwag_SilverField: ; 0x1dc8e
	call UpdatePoliwag_SilverField
	call UpdatePsyduck_SilverField
	ret

UpdatePoliwag_SilverField: ; 0x1dc95
	ld a, [wPoliwagState]
	cp $0
	ret z
...
.asm_1dcd9
	...
	cp $3
	ccf
	call z, HitPoliwag3Times_SilverField
	ld a, $1
	ld [wPoliwagState], a
	ret
...
UpdatePsyduck_SilverField: ; 0x1dd2e
	ld a, [wPsyduckState]
	cp $0
	ret z
	cp $1
...
HitPoliwag3Times_SilverField: ; 0x1ddc7
...
HitPsyduck3Times_SilverField: ; 0x1ddf4
...
AddScorePsyduckOrPoliwag_SilverField: ; 0x1de22
	ld a, [wCurrentStage]
	bit 0, a
	ret z
	ld a, $55
...
UpdateMapMoveCounters_SilverFieldBottom: ; 0x1de93
...
UpdateMapMoveCounters_SilverFieldTop: ; 0x1df15
; This is identical logic to UpdateMapMoveCounters_SilverFieldTop, but it doesn't load
; any graphics, since Poliwag and Psyduck aren't in the Top half of the Silver Field.
	ld b, $0
...
INCLUDE "data/queued_tiledata/silver_field/poliwag_psyduck.asm"

ResolveBallUpgradeTriggersCollision_SilverField: ; 0x1e356
	ld a, [wWhichPinballUpgradeTrigger]
	and a
	jp z, UpdatePinballUpgradeTriggers_SilverField
	xor a
...
.asm_1e386
	...
	and a
	jp nz, UpdatePinballUpgradeTriggers_SilverField
	xor a
	ld [wRightAlleyTrigger], a
	ld [wLeftAlleyTrigger], a
	ld [wSecondaryLeftAlleyTrigger], a
...
.toggled
	...
	lb de, $00, $09
	call PlaySoundEffect
	jp LoadPinballUpgradeTriggersGraphics_SilverField
...
.allTriggersOn
	...
	ld c, a
	ld b, $0
	ld hl, BallTypeProgression2SilverField
	add hl, bc
	ld a, [hl]
	ld [wBallType], a
	add $30
...
.done
	...
	jr LoadPinballUpgradeTriggersGraphics_SilverField

UpdatePinballUpgradeTriggers_SilverField: ; 0x1e471
	call UpdatePinballUpgradeBlinkingAnimation_SilverField
	ret z
	; fall through
LoadPinballUpgradeTriggersGraphics_SilverField: ; 0x1e475
...
.loop
	ld a, [hld]
	push hl
	call LoadPinballUpgradeTriggerGraphics_SilverField
	pop hl
	dec b
	jr nz, .loop
	ret

LoadPinballUpgradeTriggerGraphics_SilverField: ; 0x1e484
...
; Input: a = toggle state
	...
	ld hl, TileDataPointers_1e520_SilverField
	jr .load

.toggledOnGameboy
	ld hl, TileDataPointers_1e556_SilverField
	jr .load
...
.toggledOff
	...
	ld hl, TileDataPointers_1e526_SilverField
	jr .load

.toggledOffGameboy
	ld hl, TileDataPointers_1e55c_SilverField
.load
	push bc
	dec b
	sla b
	...
	inc hl
	ld b, [hl]
	ld a, Bank(TileDataPointers_1e520_SilverField)
	ld de, LoadTileLists
	call QueueGraphicsToLoadWithFunc
	pop bc
	ret

UpdatePinballUpgradeBlinkingAnimation_SilverField: ; 0x1e4b8
...
BallTypeProgression2SilverField: ; 0x1e514
...
BallTypeDegradation2SilverField: ; 0x1e51a
...
INCLUDE "data/queued_tiledata/silver_field/ball_upgrade_triggers.asm"

UpdateBallTypeUpgradeCounter_SilverField: ; 0x1e58c
	ld a, [wCapturingMon]
	and a
	ret nz
	...
	ld c, a
	ld b, $0
	ld hl, BallTypeDegradation2SilverField
	add hl, bc
	ld a, [hl]
	ld [wBallType], a
	and a
...
ResolveCAVELightCollision_SilverField: ; 0x1e5c5
	...
	inc hl
	and [hl]
	jr z, LoadCAVELightsGraphics_SilverField
	ld a, $1
	...
	call Increment_Max100
	jr LoadCAVELightsGraphics_SilverField
...
LoadCAVELightsGraphics_SilverField: ; 0x1e627
...
.loop
	ld a, [hld]
	push hl
	call LoadCAVELightGraphics_SilverField
	pop hl
	dec b
	jr nz, .loop
	ret

LoadCAVELightGraphics_SilverField: ; 0x1e636
...
; Input: a = toggle state for CAVE light
	...
	and a
	jr nz, .toggledOnGameboy
	ld hl, TileDataPointers_1e6d7_SilverField
	jr .load

.toggledOnGameboy
	ld hl, TileDataPointers_1e717_SilverField
	jr .load
...
.toggledOff
	...
	and a
	jr nz, .toggledOffGameboy
	ld hl, TileDataPointers_1e6df_SilverField
	jr .load

.toggledOffGameboy
	ld hl, TileDataPointers_1e71f_SilverField
.load
	push bc
	dec b
	sla b
	...
	inc hl
	ld b, [hl]
	ld a, Bank(TileDataPointers_1e6d7_SilverField)
	ld de, LoadTileLists
	call QueueGraphicsToLoadWithFunc
	pop bc
	ret

UpdateCAVELightsBlinking_SilverField: ; 0x1e66a
	ld a, [wCAVELightsBlinking]
	and a
	jr z, .notBlinking
...
INCLUDE "data/queued_tiledata/silver_field/cave_lights.asm"

ResolveSlotCollision_SilverField: ; 0x1e757
	ld a, [wSlotCollision]
	and a
	jr z, .noCollision
	xor a
...
DoSlotLogic_SilverField: ; 0x1e830
...
.asm_1e867
	...
	ld c, a
	ld b, $0
	ld hl, BonusStages_SilverField
	add hl, bc
	ld a, [hl]
	ld [wNextStage], a
	call ShowScrollingGoToBonusText_SilverField
	xor a
...
ShowScrollingGoToBonusText_SilverField: ; 0x1e8c3
	call FillBottomMessageBufferWithBlackTile
	call Func_30db
...
; It looks like a cover that opens and closes.
	...
	ld c, a
	ld b, $0
	ld hl, TileDataPointers_1e91e_SilverField
	ld a, [hGameBoyColorFlag]
	and a
	jr z, .asm_1e912
	ld hl, TileDataPointers_1e970_SilverField
.asm_1e912
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	...
	or h
	ret z
	ld a, Bank(TileDataPointers_1e91e_SilverField)
	call QueueGraphicsToLoad
	ret

INCLUDE "data/queued_tiledata/silver_field/slot_cave.asm"

OpenSlotCave_SilverField: ; 0x1e9c0
	ld a, [wFramesUntilSlotCaveOpens]
	and a
	ret z
	dec a
...
.asm_1e9e3
	...
	ld a, [wCurrentStage]
	bit 0, a
	call nz, LoadSlotCaveCoverGraphics_SilverField
	ret

ApplySlotForceField_SilverFieldBottom: ; 0x1ea0a
; Applies the force field to the pinball when near the slot cave opening.
	...
	sla c
	add hl, bc
	jr _ApplySlotForceField_SilverField

ApplySlotForceField_SilverFieldTop: ; 0x1ea3b
; Applies the force field to the pinball when near the slot cave opening.
...
_ApplySlotForceField_SilverField: ; 0x1ea6a
; Applies the force field to the pinball when near the slot cave opening.
...
UpdateArrowIndicators_SilverField: ; 0x1ead4
; Updates the 5 blinking arrow indicators in the silver field bottom.
	ld a, [hNumFramesDropped]
	and $f
	ret nz
	ld bc, $0000
...
LoadArrowIndicatorGraphics_SilverStage: ; 0x1eb41
	push af
	sla c
	ld hl, TileDataPointers_1eb61_SilverField
	ld a, [hGameBoyColorFlag]
	and a
	jr z, .gameboy
	ld hl, TileDataPointers_1ed51_SilverField
.gameboy
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	...
	ld h, [hl]
	ld l, a
	ld a, Bank(TileDataPointers_1eb61_SilverField)
	call QueueGraphicsToLoad
	ret

INCLUDE "data/queued_tiledata/silver_field/arrow_indicators.asm"

ResolveForceFieldCollision_SilverField: ; 0x1ef09
; Handles the collision with the directional force field in between Slowpoke and Cloyster.
	ld a, [wBlueStageForceFieldDirection]
	cp $0  ; up direction
	jp z, ResolveForceFieldCollision_Up_SilverField
	cp $1  ; right direction
	jp z, ResolveForceFieldCollision_Right_SilverField
	cp $2  ; down direction
	jp z, ResolveForceFieldCollision_Down_SilverField
	cp $3  ; left direction
	jp z, ResolveForceFieldCollision_Left_SilverField
	; fall through
	; default to upward forcefield

ResolveForceFieldCollision_Up_SilverField: ; 0x1ef20
	ld a, [wBallYPos + 1]
	sub $60
	cp $30
	ret nc
	...
	sla c
	add hl, bc
	jp ApplyForceFieldForce_SilverField

ResolveForceFieldCollision_Right_SilverField: ; 0x1ef4d
	ld a, [wBallXPos + 1]
	sub $38
	cp $30
	ret nc
...
ResolveForceFieldCollision_Down_SilverField: ; 0x1ef7e
	ld a, [wBallYPos + 1]
	sub $60
	cp $30
	ret nc
	...
	sla c
	add hl, bc
	jr ApplyForceFieldForce_SilverField

ResolveForceFieldCollision_Left_SilverField: ; 0x1efae
	ld a, [wBallXPos + 1]
	sub $38
	cp $30
	ret nc
...
ApplyForceFieldForce_SilverField: ; 0x1efdc
	ld a, [wBlueStageForceFieldDirection]
	cp $0  ; up direction
	jp z, ApplyForceFieldForce_Up_SilverField
	cp $1  ; right direction
	jp z, ApplyForceFieldForce_Right_SilverField
	cp $2  ; down direction
	jp z, ApplyForceFieldForce_Down_SilverField
	cp $3  ; left direction
	jp z, ApplyForceFieldForce_Left_SilverField
	; fall through
	; default to upward forcefield

ApplyForceFieldForce_Up_SilverField:  ; 0x1eff3
...
ApplyForceFieldForce_Down_SilverField: ; 0x1f057
	ld bc, BallPhysicsData_ec000
	add hl, bc
	ld de, wBallXVelocity
	bit 2, l
...
ApplyForceFieldForce_Right_SilverField: ; 0x1f0be
	ld bc, BallPhysicsData_ec000
	add hl, bc
...
ApplyForceFieldForce_Left_SilverField: ; 0x1f124
	ld bc, BallPhysicsData_ec000
	add hl, bc
	ld de, wBallYVelocity
	ld a, BANK(BallPhysicsData_ec000)
...
UpdateForceFieldGraphics_SilverField: ; 0x1f18a
	...
	ld c, a
	ld b, $0
	ld hl, TileDataPointers_1f1b5_SilverField
	ld a, [hGameBoyColorFlag]
	and a
	jr z, .gameboy
	ld hl, TileDataPointers_1f201_SilverField
.gameboy
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	...
	or h
	ret z
	ld a, Bank(TileDataPointers_1f1b5_SilverField)
	call QueueGraphicsToLoad
	ld a, $0
	ld [wBlueStageForceFieldGfxNeedsLoading], a
.done
...
INCLUDE "data/queued_tiledata/silver_field/force_field.asm"

UpdatePokeballs_SilverField: ; 0x1f261
; Update the pokeballs underneath the billboard, which blink for awhile after catch'em mode and evolution mode.
	call UpdateBlinkingPokeballs_SilverField
	ret nc
	; fall through

LoadPokeballsGraphics_SilverField: ; 0x1f265
; Loads the graphics for the list of pokeballs underneath the billboard picture.
	sla a
	ld c, a
	ld b, $0
	ld hl, TileDataPointers_1f2b9_SilverField
	add hl, bc
	ld a, [hli]
	ld c, a
	ld a, [hli]
	ld b, a
	ld a, Bank(TileDataPointers_1f2b9_SilverField)
	ld de, LoadTileLists
	call QueueGraphicsToLoadWithFunc
	ret

UpdateBlinkingPokeballs_SilverField: ; 0x1f27b
	ld a, [wPreviousNumPokeballs]
	ld hl, wNumPokeballs
	cp [hl]
	ret z
...
INCLUDE "data/queued_tiledata/silver_field/pokeballs.asm"

SetLeftAndRightAlleyArrowIndicatorStates_SilverField: ; 0x1f2ff
	ld a, [wLeftAlleyCount]
	cp $3
	jr c, .asm_1f30b
	ld a, $80
