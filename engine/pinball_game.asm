...
; See wHighScoresStage for more info.
	...
	db $02  ; STAGE_GOLD_FIELD_TOP
	db $02  ; STAGE_GOLD_FIELD_BOTTOM
	db $03  ; STAGE_SILVER_FIELD_TOP
	db $03  ; STAGE_SILVER_FIELD_BOTTOM
	db $04  ; STAGE_RUBY_FIELD_TOP
	db $04  ; STAGE_RUBY_FIELD_BOTTOM
	db $05  ; STAGE_SAPPHIRE_FIELD_TOP
	db $05  ; STAGE_SAPPHIRE_FIELD_BOTTOM
