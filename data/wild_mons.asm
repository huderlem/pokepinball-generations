WildMonOffsetsPointers:
	dw RedStageWildMonDataOffsets
	dw RedStageWildMonDataOffsets
	dw BlueStageWildMonDataOffsets
	dw BlueStageWildMonDataOffsets
	dw GoldStageWildMonDataOffsets
	dw GoldStageWildMonDataOffsets
	dw SilverStageWildMonDataOffsets
	dw SilverStageWildMonDataOffsets

RedStageWildMonDataOffsets:
...
WildMonPointers: ; 0x112c0
	...
	dw BlueStageWildMons
	dw GoldStageWildMons
	dw GoldStageWildMons
	dw SilverStageWildMons
	dw SilverStageWildMons
