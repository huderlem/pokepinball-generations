_LoadStageDataSapphireFieldTop: ; 0x1c165
	call LoadPinballUpgradeTriggersGraphics_SapphireField
	call UpdateSpinnerChargeGraphics_SapphireField
	call LoadEvolutionTrinketGraphics_SapphireField
	...
	call Func_1c203_SapphireField
	ret

_LoadStageDataSapphireFieldBottom: ; 0x1c191
	call Func_1c1db_SapphireField
	call LoadBillboardGraphics_SapphireField
	call Func_1c2cb_SapphireField
	call LoadCAVELightsGraphics_SapphireField
	call LoadBillboardStatusBarGraphics_SapphireField
	call Func_1c305_SapphireField
	call LoadEvolutionTrinketGraphics_SapphireField
	callba LoadAgainTextGraphics
	callba DrawBallSaverIcon
	call LoadPsyduckOrPoliwagGraphics_SapphireField
	call LoadBonusMultiplierRailingGraphics_SapphireField
	call LoadSlotCaveCoverGraphics_SapphireField
	callba LoadBallGraphics
	callba LoadTimerGraphics
	call Func_1c203_SapphireField
...
Func_1c1db_SapphireField: ; 0x1c1db
...
Func_1c203_SapphireField: ; 0x1c203
	ld a, $ff
...
LoadBonusMultiplierRailingGraphics_SapphireField: ; 0x1c21e
	ld a, $ff
	ld [wd60e], a
	ld [wd60f], a
...
LoadPsyduckOrPoliwagGraphics_SapphireField: ; 0x1c235
...
.asm_1c24a
	call _LoadPsyduckOrPoliwagGraphics_SapphireField ;load 1 if button is hit, otherwise load 0
	ld a, [wLeftMapMoveCounter]
	call LoadPsyduckOrPoliwagNumberGraphics_SapphireField ;load map move counter directly
	ld a, [wLeftMapMoveCounter]
	cp $0
...
.asm_1c269
	...
	and a
	jr z, .asm_1c28a
	ld a, [wMapMoveDirection] ;of map move direction is not 0, _LoadPsyduckOrPoliwagGraphics_SapphireField = 4 and  LoadPsyduckOrPoliwagNumberGraphics_SapphireField = wRightMapMoveCounter + 4
	and a
	jr nz, .asm_1c2bd
...
Func_1c2cb_SapphireField: ; 0x1c2cb
	ld a, [wCurrentStage]
	bit 0, a
	ret z
	ld bc, $0000
...
Func_1c305_SapphireField: ; 0x1c305
	ld a, [wInSpecialMode]
	and a
	ret z
	ld a, [wSpecialMode]
	...
	and a
	jr nz, .asm_1c31f
	jp Func_1c3ca_SapphireField

.asm_1c31f
	callba Func_1c3ac_SapphireField
	callba Func_10362
...
Func_1c3ac_SapphireField: ; 0x1c3ac
	ld a, $80
	hlCoord 7, 4, vBGMap
	call Func_1c3c3_SapphireField
	hlCoord 7, 5, vBGMap
	call Func_1c3c3_SapphireField
	hlCoord 7, 6, vBGMap
	call Func_1c3c3_SapphireField
...
Func_1c3c3_SapphireField: ; 0x1c3c3
	ld [hli], a
	ld [hli], a
	ld [hli], a
	ld [hli], a
...
Func_1c3ca_SapphireField: ; 0x1c3ca
...
LoadEvolutionTrinketGraphics_SapphireField: ; 0x1c3ee
	ld a, [wInSpecialMode]
	and a
	ret z
	ld a, [wSpecialMode]
	...
	call LoadEvolutionTrinketGfx_SapphireField
	jr .asm_1c424
...
LoadEvolutionTrinketGfx_SapphireField:
...
LoadBillboardStatusBarGraphics_SapphireField: ; 0x1c43c
	ld a, [wInSpecialMode]
	and a
	jr z, .asm_1c458
	ld a, [wSpecialMode]
	...
	ld a, [wNumMonHits]
	and a
	call nz, Func_1c46d_SapphireField
	ret

.asm_1c450
	cp SPECIAL_MODE_EVOLUTION
	jr nz, .asm_1c458
	call Func_1c47d_SapphireField
	ret

.asm_1c458
	ld a, [wPreviousNumPokeballs]
	call LoadPokeballsGraphics_SapphireField
...
Func_1c46d_SapphireField: ; 0x1c46d
	push af
	callba Func_10611
	pop af
	dec a
	jr nz, Func_1c46d_SapphireField
	ret

Func_1c47d_SapphireField: ; 0x1c47d
	ld de, $0000
	ld a, [wNumEvolutionTrinkets]
	and a
	ret z
...
.asm_1c486
	ld a, [wCurrentEvolutionType]
	call Func_1c491_SapphireField
	inc de
	dec b
	jr nz, .asm_1c486
	ret

Func_1c491_SapphireField: ; 0x1c491
	push bc
	push de
	dec a
	ld c, a
...
LoadBillboardGraphics_SapphireField: ; 0x1c4b6
	ld a, [wInSpecialMode]
	and a
	jr nz, .asm_1c4f0
