HandleSapphireCatchEmCollision: ; 0x202bc
	ld a, [wSpecialModeCollisionID]
	cp SPECIAL_COLLISION_SHELLDER
	jp z, HandleShellderCollision_CatchemMode_SapphireField
	cp SPECIAL_COLLISION_SPINNER
	jp z, HandleSpinnerCollision_CatchemMode_SapphireField
	cp SPECIAL_COLLISION_SLOWPOKE
	jp z, HandleSlowpokeCollision_CatchemMode_SapphireField
	cp SPECIAL_COLLISION_CLOYSTER
	jp z, HandleCloysterCollision_CatchemMode_SapphireField
...
.noCollision
	call CheckIfCatchemModeTimerExpired_SapphireField
	ld a, [wSpecialModeState]
	call CallInFollowingTable
CatchemModeCallTable_SapphireField: ; 0x202e2
	padded_dab Func_20302_SapphireField
	padded_dab Func_20320_SapphireField
	padded_dab Func_2032c_SapphireField
	padded_dab ShowAnimatedCatchemPokemon_SapphireField
	padded_dab UpdateMonState_CatchemMode_SapphireField
	padded_dab CatchPokemon_SapphireField
	padded_dab CapturePokemonAnimation_SapphireField
	padded_dab ConcludeCatchemMode_SapphireField

Func_20302_SapphireField: ; 0x20302
...
Func_20320_SapphireField: ; 0x20320
	callba Func_10648
	scf
	ret

Func_2032c_SapphireField: ; 0x2032c
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_20333
	call Func_1130
...
ShowAnimatedCatchemPokemon_SapphireField: ; 0x20364
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_20370
	call Func_1130
...
UpdateMonState_CatchemMode_SapphireField: ; 0x20394
...
CatchPokemon_SapphireField: ; 0x20454
	ld a, [wd580]
	and a
	jr z, .asm_2045f
	xor a
...
CapturePokemonAnimation_SapphireField: ; 0x20483
	callba CapturePokemonAnimation
	scf
	ret

ConcludeCatchemMode_SapphireField: ; 0x2048f
...
CheckIfCatchemModeTimerExpired_SapphireField: ; 0x204b3
...
HandleShellderCollision_CatchemMode_SapphireField: ; 0x204f1
	ld a, [wNumberOfCatchModeTilesFlipped]
	cp 24
...
HandleSpinnerCollision_CatchemMode_SapphireField: ; 0x20569
	ld bc, $0000
	ld de, $1000
	call AddBCDEToJackpot
	ret

HandleSlowpokeCollision_CatchemMode_SapphireField: ; 0x20573
	ld bc, $0005
	ld de, $0000
	ret

HandleCloysterCollision_CatchemMode_SapphireField: ; 0x2057a
	ld bc, $0005
	ld de, $0000
	ret
