HandleSilverCatchEmCollision: ; 0x202bc
	...
	jp z, HandleShellderCollision_CatchemMode_SilverField
	cp SPECIAL_COLLISION_SPINNER
	jp z, HandleSpinnerCollision_CatchemMode_SilverField
	cp SPECIAL_COLLISION_SLOWPOKE
	jp z, HandleSlowpokeCollision_CatchemMode_SilverField
	cp SPECIAL_COLLISION_CLOYSTER
	jp z, HandleCloysterCollision_CatchemMode_SilverField
...
.noCollision
	call CheckIfCatchemModeTimerExpired_SilverField
	ld a, [wSpecialModeState]
	call CallInFollowingTable
CatchemModeCallTable_SilverField: ; 0x202e2
	padded_dab Func_20302_SilverField
	padded_dab Func_20320_SilverField
	padded_dab Func_2032c_SilverField
	padded_dab ShowAnimatedCatchemPokemon_SilverField
	padded_dab UpdateMonState_CatchemMode_SilverField
	padded_dab CatchPokemon_SilverField
	padded_dab CapturePokemonAnimation_SilverField
	padded_dab ConcludeCatchemMode_SilverField

Func_20302_SilverField: ; 0x20302
...
Func_20320_SilverField: ; 0x20320
	callba Func_10648
	scf
	ret

Func_2032c_SilverField: ; 0x2032c
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_20333
	call Func_1130
...
ShowAnimatedCatchemPokemon_SilverField: ; 0x20364
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_20370
	call Func_1130
...
UpdateMonState_CatchemMode_SilverField: ; 0x20394
...
CatchPokemon_SilverField: ; 0x20454
	ld a, [wd580]
	and a
	jr z, .asm_2045f
	xor a
...
CapturePokemonAnimation_SilverField: ; 0x20483
	callba CapturePokemonAnimation
	scf
	ret

ConcludeCatchemMode_SilverField: ; 0x2048f
...
CheckIfCatchemModeTimerExpired_SilverField: ; 0x204b3
...
HandleShellderCollision_CatchemMode_SilverField: ; 0x204f1
	ld a, [wNumberOfCatchModeTilesFlipped]
	cp 24
...
HandleSpinnerCollision_CatchemMode_SilverField: ; 0x20569
	ld bc, $0000
	ld de, $1000
	call AddBCDEToJackpot
	ret

HandleSlowpokeCollision_CatchemMode_SilverField: ; 0x20573
	ld bc, $0005
	ld de, $0000
	ret

HandleCloysterCollision_CatchemMode_SilverField: ; 0x2057a
	ld bc, $0005
	ld de, $0000
	ret
