...
; Note only, evolution mons use an arbitrary non-evolved mon entry, since it will never be used.
	...
	dwb GrovyleAnimatedCollisionMask, Bank(GrovyleAnimatedCollisionMask)
	dwb SceptileAnimatedCollisionMask, Bank(SceptileAnimatedCollisionMask)
	dwb TorchicAnimatedCollisionMask, Bank(TorchicAnimatedCollisionMask)
	dwb CombuskenAnimatedCollisionMask, Bank(CombuskenAnimatedCollisionMask)
	dwb BlazikenAnimatedCollisionMask, Bank(BlazikenAnimatedCollisionMask)
	dwb MudkipAnimatedCollisionMask, Bank(MudkipAnimatedCollisionMask)
	dwb MarshtompAnimatedCollisionMask, Bank(MarshtompAnimatedCollisionMask)
	dwb SwampertAnimatedCollisionMask, Bank(SwampertAnimatedCollisionMask)
	dwb PoochyenaAnimatedCollisionMask, Bank(PoochyenaAnimatedCollisionMask)
	dwb MightyenaAnimatedCollisionMask, Bank(MightyenaAnimatedCollisionMask)
	dwb ZigzagoonAnimatedCollisionMask, Bank(ZigzagoonAnimatedCollisionMask)
	dwb LinooneAnimatedCollisionMask, Bank(LinooneAnimatedCollisionMask)
	dwb WurmpleAnimatedCollisionMask, Bank(WurmpleAnimatedCollisionMask)
	dwb SilcoonAnimatedCollisionMask, Bank(SilcoonAnimatedCollisionMask)
	dwb BeautiflyAnimatedCollisionMask, Bank(BeautiflyAnimatedCollisionMask)
	dwb CascoonAnimatedCollisionMask, Bank(CascoonAnimatedCollisionMask)
	dwb DustoxAnimatedCollisionMask, Bank(DustoxAnimatedCollisionMask)
	dwb LotadAnimatedCollisionMask, Bank(LotadAnimatedCollisionMask)
	dwb LombreAnimatedCollisionMask, Bank(LombreAnimatedCollisionMask)
	dwb LudicoloAnimatedCollisionMask, Bank(LudicoloAnimatedCollisionMask)
	dwb SeedotAnimatedCollisionMask, Bank(SeedotAnimatedCollisionMask)
	dwb NuzleafAnimatedCollisionMask, Bank(NuzleafAnimatedCollisionMask)
	dwb ShiftryAnimatedCollisionMask, Bank(ShiftryAnimatedCollisionMask)
