HandleRubyCatchEmCollision: ; 0x20000
	ld a, [wSpecialModeCollisionID]
	cp SPECIAL_COLLISION_VOLTORB
	jp z, HandleVoltorbCollision_CatchemMode_RubyField
	cp SPECIAL_COLLISION_SPINNER
	jp z, HandleSpinnerCollision_CatchemMode_RubyField
	cp SPECIAL_COLLISION_BELLSPROUT
	jp z, HandleBellsproutCollision_CatchemMode_RubyField
...
.noCollision
	call CheckIfCatchemModeTimerExpired_RubyField
	ld a, [wSpecialModeState]
	call CallInFollowingTable
CatchemModeCallTable_RubyField: ; 0x20021
	padded_dab Func_20041_RubyField
	padded_dab Func_2005f_RubyField
	padded_dab Func_2006b_RubyField
	padded_dab ShowAnimatedCatchemPokemon_RubyField
	padded_dab UpdateMonState_CatchemMode_RubyField
	padded_dab CatchPokemon_RubyField
	padded_dab CapturePokemonAnimation_RubyField
	padded_dab ConcludeCatchemMode_RubyField

Func_20041_RubyField: ; 0x20041
...
Func_2005f_RubyField: ; 0x2005f
	callba Func_10648
	scf
	ret

Func_2006b_RubyField: ; 0x2006b
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_20098
	call Func_1130
...
ShowAnimatedCatchemPokemon_RubyField: ; 0x200a3
	ld a, [wCurrentStage]
	bit 0, a
	jr z, .asm_200af
	call Func_1130
...
UpdateMonState_CatchemMode_RubyField: ; 0x200d3
...
CatchPokemon_RubyField: ; 0x20193
	ld a, [wd580]
	and a
	jr z, .asm_2019e
	xor a
...
CapturePokemonAnimation_RubyField: ; 0x201c2
	callba CapturePokemonAnimation
	scf
	ret

ConcludeCatchemMode_RubyField: ; 0x201ce
...
CheckIfCatchemModeTimerExpired_RubyField: ; 0x201f2
...
HandleVoltorbCollision_CatchemMode_RubyField: ; 0x20230
	ld a, [wNumberOfCatchModeTilesFlipped]
	cp $18
	jr z, .asm_2029d
	sla a
...
HandleSpinnerCollision_CatchemMode_RubyField: ; 0x202a8
	ld bc, $0000
	ld de, $1000
	call AddBCDEToJackpot
	ret

HandleBellsproutCollision_CatchemMode_RubyField: ; 0x202b2
	ld bc, $0005
	ld de, $0000
	call AddBCDEToJackpot
	ret
